...
export function buildTwoPathBracket(): TwoPathBracket {
  return {
    slots: [
      ...
      { phase: "q5", legs: 1, gwOffsets: [2], home: winner("q1"), away: winner("q4"), onWin: "q7", onLose: "e9" },
      { phase: "q6", legs: 1, gwOffsets: [2], home: winner("q2"), away: winner("q3"), onWin: "q7", onLose: "e9" },
      { phase: "e5", legs: 1, gwOffsets: [2], home: loser("q1"), away: loser("q4"), onWin: "e10" },
      { phase: "e6", legs: 1, gwOffsets: [2], home: loser("q2"), away: loser("q3"), onWin: "e11" },
      { phase: "e7", legs: 1, gwOffsets: [3], home: winner("e1"), away: winner("e4"), onWin: "e10" },
      { phase: "e8", legs: 1, gwOffsets: [3], home: winner("e2"), away: winner("e3"), onWin: "e11" },
      { phase: "e9", legs: 1, gwOffsets: [4], home: loser("q5"), away: loser("q6"), onWin: "decider" },
      { phase: "e10", legs: 1, gwOffsets: [4], home: winner("e5"), away: winner("e8"), onWin: "decider" },
      { phase: "e11", legs: 1, gwOffsets: [5], home: winner("e6"), away: winner("e7"), onWin: "decider" },
